...
export default function Game({ player, leaderboard, onScoreUpdate, onPlayAgain }: GameProps) {
  ...
  return (
    <main className="flex flex-col lg:flex-row min-h-screen items-center justify-center gap-4 lg:gap-8 p-2 sm:p-4 bg-background overflow-hidden">
        ...
        <div className="w-full max-w-sm md:max-w-md flex justify-around items-center">
          <Card className="shadow-lg">
              <CardHeader className="p-2 sm:p-4">
                  <CardTitle className="text-center text-md sm:text-lg font-bold text-primary flex items-center justify-center gap-2">
                      <Trophy className="w-5 h-5 text-yellow-400"/> Score
                  </CardTitle>
              </CardHeader>
              <CardContent className="p-2 pt-0 sm:p-4 sm:pt-0 text-center">
          ...
          <Card className="shadow-lg">
              ...
              <CardContent className="p-2 pt-0 sm:p-4 sm:pt-0 text-center">
                  <p className="text-2xl sm:text-3xl font-bold">{shotsRemaining}</p>
              </CardContent>
          </Card>
        </div>
      </div>

      <aside className="w-full max-w-sm md:max-w-md lg:w-72 flex flex-col gap-6 items-center">
